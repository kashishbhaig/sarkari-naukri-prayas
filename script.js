...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Preloader - hide after delay or immediately if error
    setTimeout(() => {
    ...
    } catch (e) { console.error('Sticky header error:', e); }
    ...
    } catch (e) { console.error('Search modal error:', e); }

    try {
        initAnimatedCounters();
        console.log('Animated counters initialized');
    } catch (e) { console.error('Counters error:', e); }

    try {
        populateExamsTable();
        console.log('Exams table populated');
    } catch (e) { console.error('Exams table error:', e); }
    ...
    } catch (e) { console.error('Back to top error:', e); }
...
function populateExamsTable(filter = 'all') {
    ...
    if (!tbody) {
        console.warn('Exams table body not found');
        return;
    }
...
function populateNotifications() {
    ...
    if (!notificationsGrid) {
        console.warn('Notifications grid not found');
        return;
    }
